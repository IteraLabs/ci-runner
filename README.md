...
│ load      0.74 0.42 0.26             ││ uptime    2h 45m                     │
│ tasks     3 runnable / 234           ││ last job  2026-07-30 18:32 UTC       │
└──────────────────────────────────────┘└──────────────────────────────────────┘
┌───────────────────────────────── cpu ┐┌──────────────────────────────── temp ┐
│ cpu_0     [█████████████████] 100%   ││ cpu-temp  [███░░░░░░]  42%  53.3 C   │
│ cpu_1     [░░░░░░░░░░░░░░░░░]   1%   ││ fan       OFF                        │
│ cpu_2     [░░░░░░░░░░░░░░░░░]   5%   ││ fan-speed 0 RPM                      │
│ cpu_3     [█████████████████] 100%   ││                                      │
└──────────────────────────────────────┘└──────────────────────────────────────┘
┌────────────────────────────────────────────────────────────────────── memory ┐
│ ram       [██░░░░░░░░░░░░░░░░░░░░░]  13%  520.2 MiB / 3.6 GiB  cache 3.0 GiB │
│ swap      [░░░░░░░░░░░░░░░░░░░░░░░]   0%  512.0 KiB / 7.9 GiB                │
│ disk      [████████░░░░░░░░░░░░░░░]  37%  20.5 GiB / 57.9 GiB  free 35.0 GiB │
└──────────────────────────────────────────────────────────────────────────────┘
┌────────────────────────────────────────────────────────────────── networking ┐
│ eth0      up    100 Mb  rx      579 B/s  tx      391 B/s                     │
│ wlan0     up        --  rx      199 B/s  tx        0 B/s                     │
└──────────────────────────────────────────────────────────────────────────────┘
  q quit   r refresh
```

Fits 80x24. The key hints appear at 26 rows and up. Per-core rows collapse to
one aggregate row on shorter terminals.
...
| | citop | htop |
|---|---|---|
| CPU | 0.75 % of one core | 4.25 % of one core |
